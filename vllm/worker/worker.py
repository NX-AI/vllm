...
class Worker(LocalOrDistributedWorkerBase):
    ...
    def __init__(
        ...
        speculative_args = (
            ...
            or (speculative_config.draft_model_config.hf_config.model_type not in ["medusa", "mlp_speculator", "eagle"])
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        available_kv_cache_memory = memory_for_current_instance - result.non_kv_cache_memory_in_bytes
    ...
    def _execute_model_spmd(
        ...
        if execute_model_req is not None:
            new_seq_group_metadata_list = self._get_cached_seq_group_metadata(
                execute_model_req.seq_group_metadata_list, execute_model_req.finished_requests_ids
            )
...
def raise_if_cache_size_invalid(num_gpu_blocks, block_size, is_attention_free, max_model_len) -> None:
